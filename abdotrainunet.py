...
from convnets import VQUNet3D, UNet3Dv2, VQUNet3Dpos, VQUNet3Dposv3, GumbelUNet3Dpos
...
class Net(pytorch_lightning.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputabdo/unet1/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputabdo/unet1/testresults/', exist_ok=True)
        df.to_csv('/vol/biomedic3/as217/vqseg/outputabdo/unet1/testresults/result.csv')
...
# initialise Lightning's trainer.
      ...
      #trainer.fit(net)
      os.makedirs('/vol/biomedic3/as217/vqseg/outputabdo/unet1/testimagesoutput/ ', exist_ok=True)
      net = Net()
      model = net.load_from_checkpoint(os.path.join(root_dir, "best_metric_model-v2.ckpt"))
      model.eval()
      trainer.test(model)
