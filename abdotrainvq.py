...
from convnets import VQUNet3D, UNet3D, VQUNet3Dpos, VQUNet3Dposv3, GumbelUNet3Dpos, VQUNet3Dlarge
...
class Net(pytorch_lightning.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputabdo/vqfinal/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputabdo/vqfinal/testresults/', exist_ok=True)
        df.to_csv('/vol/biomedic3/as217/vqseg/outputabdo/vqfinal/testresults/result.csv')
...
# initialise Lightning's trainer.
      ...
      trainer.fit(net)
      os.makedirs('/vol/biomedic3/as217/vqseg/outputabdo/vqfinal/testimagesoutput/', exist_ok=True)
      net = Net()
