...
#        self.automatic_optimization = False
    ...
    def test_step(self, batch, batch_idx):
       ...
       # dice1, num_items1, hd1, asd1 = 0, 0, 0, 0
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqJRST/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqJRST/testresults/', exist_ok=True)
        df.to_csv( '/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqJRST/testresults/result.csv')
...
if    __name__ == '__main__':
    ...
    data = JSRTDataloader(
        ...
        csv_path="/vol/biomedic3/mmr12/data/chestXR/JSRT/",
        csv_names=["JSRT_{}.csv".format(_set) for _set in ['train', 'val', 'test']],
        input_channels=1
    )
    root_dir = 'outputchestsegfinal/vqJRST'
        # set up checkpoints
    ...
    os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqJRST/testimagesoutput/ ', exist_ok=True)
    net = Net()
