...
#        self.automatic_optimization = False
    ...
    def test_step(self, batch, batch_idx):
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputprostatefinal/unetRUMtoBMC/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputprostatefinal/unetRUMtoBMC/testresults/', exist_ok=True)
        df.to_csv('/vol/biomedic3/as217/vqseg/outputprostatefinal/unetRUMtoBMC/testresults/result.csv')
...
if __name__ == '__main__':
        ...
        data = ProstateDataModule(
            batch_size=1,
            num_workers=4,
            csv_train_img="/vol/biomedic3/as217/vqseg/ProstateDomain/Prostatedomaints1.csv",
            csv_val_img="/vol/biomedic3/as217/vqseg/ProstateDomain/ProstatedomainvalBMC1.csv",
            csv_test_img="/vol/biomedic3/as217/vqseg/ProstateDomain/Prostatedomaintr1.csv",
        )

        root_dir = 'outputprostatefinal/unetRUMtoBMC'
        # set up checkpoints
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputprostatefinal/unetRUMtoBMC/testimagesoutput/ ', exist_ok=True)
        net = Net()
