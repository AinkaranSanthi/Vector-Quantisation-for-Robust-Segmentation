...
class Net(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
       ...
       # dice1, num_items1, hd1, asd1 = 0, 0, 0, 0
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetJRST/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetJRST/testresults/', exist_ok=True)
        df.to_csv( '/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetJRST/testresults/result.csv')
...
if    __name__ == '__main__':
    ...
    root_dir = 'outputchestsegfinal/unetJRST'
        # set up checkpoints
    ...
    os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetJRST/testimagesoutput/ ', exist_ok=True)
    net = Net()
