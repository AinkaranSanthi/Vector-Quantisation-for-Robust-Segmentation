...
#        self.automatic_optimization = False
    ...
    def test_step(self, batch, batch_idx):
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputprostatefinal/gumRUMtoBMC/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputprostatefinal/gumRUMtoBMC/testresults/', exist_ok=True)
        df.to_csv('/vol/biomedic3/as217/vqseg/outputprostatefinal/gumRUMtoBMC/testresults/result.csv')
...
if __name__ == '__main__':
        ...
        root_dir = 'outputprostatefinal/gumRUMtoBMC'
        # set up checkpoints
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputprostatefinal/gumRUMtoBMC/testimagesoutput/ ', exist_ok=True)
        net = Net()
