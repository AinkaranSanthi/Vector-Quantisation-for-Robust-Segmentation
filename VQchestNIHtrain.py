...
from monai.metrics import compute_meandice, DiceMetric, compute_hausdorff_distance, compute_average_surface_distance
...
class JSRTDataloader(LightningDataModule):
    def __init__(self, batch_size, csv_names, num_workers=8, **kwargs):
        super().__init__()
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.datasets = [JSRTDataset(csv_name=_csv_name, **kwargs) for _csv_name in csv_names]
...
#        self.automatic_optimization = False
    ...
    def test_step(self, batch, batch_idx):
       ...
       # dice1, num_items1, hd1, asd1 = 0, 0, 0, 0
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqNIH/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqNIH/testresults/', exist_ok=True)
        df.to_csv( '/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqNIH/testresults/result.csv')
...
if    __name__ == '__main__':
    ...
    root_dir = 'outputchestsegfinal/vqNIH'
        # set up checkpoints
    ...
    os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/vqNIH/testimagesoutput/ ', exist_ok=True)
    net = Net()
