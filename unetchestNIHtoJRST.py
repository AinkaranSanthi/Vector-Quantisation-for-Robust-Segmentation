...
import torchvision
from convnets import GumbelUNet2Dpos, UNet2D
...
class Net(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
       ...
       # dice1, num_items1, hd1, asd1 = 0, 0, 0, 0
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetNIHtoJRST/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetNIHtoJRST/testresults/', exist_ok=True)
        df.to_csv( '/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetNIHtoJRST/testresults/result.csv')
...
if    __name__ == '__main__':
    ...
    root_dir = 'outputchestsegfinal/unetNIHtoJRST'
        # set up checkpoints
    ...
    os.makedirs('/vol/biomedic3/as217/vqseg/outputchestsegfinal/unetNIHtoJRST/testimagesoutput/ ', exist_ok=True)
    net = Net()
