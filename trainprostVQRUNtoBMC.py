...
#        self.automatic_optimization = False
    ...
    def test_step(self, batch, batch_idx):
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputprostatefinal/vqRUMtoBMC/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputprostatefinal/vqRUMtoBMC/testresults/', exist_ok=True)
        df.to_csv('/vol/biomedic3/as217/vqseg/outputprostatefinal/vqRUMtoBMC/testresults/result.csv')
...
if __name__ == '__main__':
        ...
        root_dir = 'outputprostatefinal/vqRUMtoBMC'
        # set up checkpoints
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputprostatefinal/vqRUMtoBMC/testimagesoutput/ ', exist_ok=True)
        net = Net()
