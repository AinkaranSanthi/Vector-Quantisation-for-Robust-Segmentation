...
class Net(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
       ...
       # dice1, num_items1, hd1, asd1 = 0, 0, 0, 0
        ...
        imagespath = '/vol/biomedic3/as217/vqseg/outputchestseg/unetNIHtoJRST/testimagesoutput/'
        ...
        os.makedirs('/vol/biomedic3/as217/vqseg/outputchestseg/unetNIHtoJRST/testresults/', exist_ok=True)
        df.to_csv( '/vol/biomedic3/as217/vqseg/outputchestseg/unetNIHtoJRST/testresults/result.csv')
...
if    __name__ == '__main__':
    ...
    trainer = pytorch_lightning.Trainer(
        ...
        logger=TensorBoardLogger('outputchestseg/unetNIHtoJRST', name=out_name),
    )
    trainer.fit(net, data)
    os.makedirs('/vol/biomedic3/as217/vqseg/outputchestseg/unetNIHtoJRST/testimagesoutput/ ', exist_ok=True)
